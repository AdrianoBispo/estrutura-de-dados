...
A linked list is a fundamental data structure in computer science. It mainly allows efficient insertion and deletion operations compared to [arrays](https://www.geeksforgeeks.org/dsa/introduction-to-arrays-data-structure-and-algorithm-tutorials/). Like arrays, it is also used to implement other data structures like stack, queue and deque.
...
-   [Implement LRU Cache](https://www.geeksforgeeks.org/system-design/lru-cache-implementation/)[](https://www.geeksforgeeks.org/dsa/circular-linked-list-implementation-of-circular-queue/)
-   [Clone a linked list with random pointer](https://www.geeksforgeeks.org/dsa/a-linked-list-with-next-and-arbit-pointer/)
-   [Binary Tree to Doubly Linked List](https://www.geeksforgeeks.org/dsa/convert-given-binary-tree-to-doubly-linked-list-in-linear-time/ "Permalink to Convert a given Binary Tree to Doubly Linked List | Set 4")
-   [Reverse a Singly Linked List in Groups](https://www.geeksforgeeks.org/dsa/reverse-a-linked-list-in-groups-of-given-size/)
-   [Reverse a Doubly Linked List in Groups](https://www.geeksforgeeks.org/dsa/reverse-doubly-linked-list-groups-given-size/)
-   [Sublist Search](https://www.geeksforgeeks.org/dsa/sublist-search-search-a-linked-list-in-another-list/)
-   [Linked list from 2D matrix](https://www.geeksforgeeks.org/dsa/construct-linked-list-2d-matrix/)
-   [Rotate Linked List block wise](https://www.geeksforgeeks.org/dsa/rotate-linked-list-block-wise/)
-   [Multiply two numbers as Lists](https://www.geeksforgeeks.org/dsa/multiply-two-numbers-represented-linked-lists/)
-   [Delete N nodes after M nodes](https://www.geeksforgeeks.org/dsa/delete-n-nodes-after-m-nodes-of-a-linked-list/)